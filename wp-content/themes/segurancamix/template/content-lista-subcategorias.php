<div class="megamenu-subcategories menu-<?php echo $args['key']; ?>">
    <?php
...
?>
    <div class="megamenu-subcategories-sub menu-sub-<?php echo $key; ?>">
        <!-- <span class="megamenu-subcategories__title">Subcategorias</span> -->
    ...
    ?>
        <div class="megamenu-subcategories-sub-sub menu-with__more_sub-<?php echo $key; ?>">
            <!-- <span class="megamenu-subcategories__title">Subcategorias</span> -->
